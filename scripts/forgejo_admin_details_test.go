...
{{if $sodaView}}
  ...
  <div class="admin-setting-content soda-page-container">
    ...
    <link rel="stylesheet" href="{{AppSubUrl}}/assets/soda-settings.css?v=2026-09-15.workspace-entry-1">
    {{if eq $sodaView "tailnet"}}<link rel="stylesheet" href="{{AppSubUrl}}/assets/soda-tailnet.css?v=2026-09-15.workspace-entry-1">{{end}}
    ...
    <script type="module" src="{{AssetUrlPrefix}}/soda/forgejo/soda-native-page.js?v=2026-09-15.workspace-entry-1"></script>
  </div>
