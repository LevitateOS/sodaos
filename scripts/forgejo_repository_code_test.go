...
func TestForgejoCodeAndWorkflowOverridesKeepNativeBodies(t *testing.T) {
	cases := []struct {
		...
		{"repo/actions/no_workflows.tmpl", "91b7fc0d341981a988ef5ee4d31a4c4e5ff16eeea4bf1405c9114c86819609f4", [][2]string{{`<img src="{{AssetUrlPrefix}}/soda/forgejo/workflows-papercraft.png" width="180" height="120" alt="">`, `{{svg "octicon-no-entry" 48}}`}, {"class=\"empty-placeholder soda-empty soda-code-no-workflows\"", "class=\"empty-placeholder\""}, {"<h2 class=\"soda-empty-title\">", "<h2>"}, {"<p class=\"soda-empty-description\">", "<p>"}}},
