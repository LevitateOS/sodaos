...
The local x86_64 test host now serves the native Forgejo installer and Cockpit; see [local testing](local-testing.md). Dashboard OAuth, browser-trusted activation and the developer login journey remain unverified. No live registration is performed by editing these sources.
