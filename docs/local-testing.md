...
Recorded test source: `3a12d135bc4362273c209d78a40b7458993cb373` **plus the then-uncommitted native-startup fixes**, subsequently committed in `88be176`. No artifact publication occurred during that run. These results do not cover later formatting changes or the merged branding, console and project-CLI follow-ups; the merged tree has not been rebuilt or retested.
