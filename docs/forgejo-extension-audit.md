...
| Build and delivery | [`build-forgejo.ts`](../scripts/build-forgejo.ts) builds one shared Lit runtime and versioned public-relative module graph from [`forgejo-payload.json`](../internal/release/build/forgejo-payload.json). [`stage.py`](../scripts/stage.py) and [`bundle.go`](../internal/release/build/bundle.go) stage/verify the reviewed payload and terminal assets rather than a separate hand-maintained deployment list. |
