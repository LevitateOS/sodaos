...
See the [asset inventory](../../assets/README.md) for previews, source locations, dependencies, and regeneration notes. Installed Forgejo/Cockpit branding integration follows [Forgejo customization](../reference/forgejo.md) and [Cockpit](../development/cockpit.md).
