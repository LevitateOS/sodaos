...
| A06 | Historical React validator/input work is now removed with the standalone dashboard; new bundles reject retired SPA output | Rebuild/check the embedded Go HTML and retained Cockpit payload; old bundles retain their original verifier |
