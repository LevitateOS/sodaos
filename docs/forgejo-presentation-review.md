...
are not served by the appliance or shipped as mock Forgejo pages. Their paths
refer to the capturing workspace; Git merges do not transfer those private/local
outputs or establish fresh evidence in another workspace.
