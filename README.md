...
separate Cockpit Tailnet/Runners pages remain. **The read-only Sodaspaces drawer passed its isolated local browser journey; actual-stage/delivery checks and mutation controls remain pending.**
