...
func TestBindChannelReleasesRequiresArchitectures(t *testing.T) {
	require.Error(t, bindChannelReleases(&Channel{}, "ghcr.io/example/sodaos-release@sha256:"+string(make([]byte, 0))))
	offer := Channel{Releases: map[string]string{"x86_64": "old"}}
