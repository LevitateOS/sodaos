...
func observeContent(payload appliancerelease.Payload) (map[string]any, error) {
	files, size, err := appliancerelease.VerifyContent(payload, appliancerelease.ImagesPath)
	if err != nil {
		return nil, err
	}
