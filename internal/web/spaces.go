...
func (s *Server) resolveSpaceAuthority(request *http.Request, v store.Session, p store.Project) (environmentReader, bool, bool) {
...
func (s *Server) inspectSpaceNative(ctx context.Context, p store.Project, row *spaceView) bool {
...
func (s *Server) inspectSpaceTerminals(
...
func (s *Server) inspectSpaceTailnet(check context.Context, p store.Project, reader environmentReader, row *spaceView) {
...
func (s *Server) verifySpacesSession(w http.ResponseWriter, ctx context.Context, cookieValue string, v store.Session) bool {
