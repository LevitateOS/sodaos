...
func fixtureBundle(t *testing.T) string {
	...
	paths := []string{
		...
		"inputs/cockpit-bun.lock", "inputs/native-build.json", "inputs/go.mod", "inputs/go.sum", "notices/README.md", "notices/tea-LICENSE", "notices/avatar-dependencies.txt", "notices/soda-LICENSE", "notices/soda-NOTICE", "tools/soda-artifacts", "install-native.sh",
	}
