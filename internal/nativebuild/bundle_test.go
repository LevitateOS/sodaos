...
func fixtureBundle(t *testing.T) string {
	...
	paths := []string{
		...
		"inputs/native-build.json", "inputs/go.mod", "inputs/go.sum", "notices/README.md", "notices/tea-LICENSE", "notices/avatar-dependencies.txt", "tools/soda-artifacts", "install-native.sh",
	}
