...
const now = 1000000;
const metadata: TerminalMetadata = {id: 'a'.repeat(32), request_id: 'b'.repeat(32), environment_id: 'p' + '1'.repeat(24), repository_id: '7', user_id: '1', login: 'alice', name: '', created_at: 1, hard_until: 10000, retain_until: 0, effective_until: 10000, ready: true, attached: false, state: 'ready'};
