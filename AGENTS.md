...
- **Use Forgejo's official template overrides for Forgejo-owned workflows.**
  ...
  authentication/notification context. [Lit](docs/lit.md) now owns management drawer
  rendering; terminal controls and the full workspace are still pending; the [implementation sequence](docs/lit-migration-plan.md)
