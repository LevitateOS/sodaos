...
export function mountSodaspaces(root: HTMLElement, {expectedUserId, repositoryId}: DrawerContext, terminalFactory: (...args: Parameters<typeof mountTerminal>) => DrawerTerminal = mountTerminal) {
  ...
  let keyPreview: KeyPreview | undefined, terminal: DrawerTerminal | undefined, readController: AbortController | undefined;
  let busy = false, stale = false, disposed = false, uncertain = false, epoch = 0;
  let terminalTarget: string | undefined;
